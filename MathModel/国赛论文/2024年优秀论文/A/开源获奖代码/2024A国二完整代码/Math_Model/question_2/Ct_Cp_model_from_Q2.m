...
% 保存模型和特征均值、标准差
save(fullfile(model_root, 'mdl_Cp.mat'), 'mdl_Cp');
save(fullfile(model_root, 'mdl_Ct.mat'), 'mdl_Ct');
save(fullfile(model_root, 'feature_mean_std.mat'), 'feature_mean', 'feature_std');
